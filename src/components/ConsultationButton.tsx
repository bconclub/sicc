  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-24 right-4 sm:right-6 z-50 bg-red-inferno text-white p-3 sm:p-4 rounded-full shadow-lg hover:bg-red-inferno/90 transition-colors"
